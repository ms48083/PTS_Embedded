/****************************************************************
   ...
   13-Nov-17   v438 Setup for remote touch screen; pass purge_mode=0 for now

*****************************************************************/
#define FIRMWARE_VERSION "Mainstream V4.38"
#define VERS                            4
#define SUBVERS                         38
...
{  // view 0 for initial startup splash (no wait)
   ...
   lcd_Font("16");
   lcd_DispText("Colombo Pneumatic Tube Systems", 55, 180, MODE_NORMAL);
