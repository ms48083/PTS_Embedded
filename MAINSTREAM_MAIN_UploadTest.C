...
*****************************************************************/
#define FIRMWARE_VERSION "Mainstream V4.15"
...
const struct{
 ...
 MNU_SECURE_L3DIGITS,"CARD LEFT 3 DIGITS", MNU_VAL,  &param.cardL3Digits, 154, 154, "ID",
 MNU_SECURE_R9MIN,   "CARD RIGHT 9 MIN",   MNU_VAL,  (char *)&param.cardR9Min, 200000000, 618000000, "ID",
 MNU_SECURE_R9MAX,   "CARD RIGHT 9 MAX",   MNU_VAL,  (char *)&param.cardR9Max, 200000000, 618000000, "ID",
