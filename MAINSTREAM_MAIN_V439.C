/****************************************************************
   ...
   28-May-18   v439 Setup for optional portrait screen orientation

*****************************************************************/
#define FIRMWARE_VERSION "Mainstream V4.39"
#define VERS                            4
#define SUBVERS                         39
...
//   char subversion;       // Main subversion
   ...
   char reserved[95];    // to separate standard parameters from the user id's
