...
*****************************************************************/
#define FIRMWARE_VERSION "Mainstream V4.36"
#define VERS                            4
#define SUBVERS                         36
...
//   char subversion;       // Main subversion
   ...
   char reserved[97];    // to separate standard parameters from the user id's
...
int sendUDPcommand(struct UDPmessageType UDPmessage)
{
   ...
   UDPmessage.devType = 4; // NEW main station    1; // main station
