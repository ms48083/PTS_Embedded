...
#class auto
#define FIRMWARE_VERSION "TOUCH REMOTE V4.20"
#define VERSION                         4
...
{  // view 0 for initial startup splash (no wait)
   ...
   // Logo splash screen
	...
	lcd_DispBitmap( BMP_COLOMBO_LOGO, 40, 80 );
   lcd_Font("16");
   lcd_DispText("Colombo Pneumatic Tube Systems", 15, 280, MODE_NORMAL);
   lcd_DispText("800-547-2820", 75, 300, MODE_NORMAL);
   if (view)
		...
		{
	      {
	         ...
	         lcd_ButtonDef( BTN_MENU,
	            ...
	            BTN_TLXY, 13, 280,            // starting x,y for buttons
