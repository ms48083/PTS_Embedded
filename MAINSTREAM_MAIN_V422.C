...
*****************************************************************/
#define FIRMWARE_VERSION "Mainstream V4.22"
#define VERS                            4
#define SUBVERS                         22
...
//UID_Del(NULL); // DELETE ALL USERS
//printf("DEFAULT UIDSync to yesterday\n");
//param.UIDSync = SEC_TIMER-86400; // default to yesterday
//UID_Decode("987654", mybuf);
//printf("%s\n", mybuf);
//UID_Encode("154123456789", mybuf);
//printf("%s\n", mybuf);
//printf("add 0 %d\n", UID_Add("554123456789"));
//printf("add 1 %d\n", UID_Add("445566778899"));
//printf("del 0 %d\n", UID_Del("554123456789"));
//printf("add 0 %d\n", UID_Add("455667788990"));
//printf("add 0 %d\n", UID_Add("455667788990"));
//printf("add 2 %d\n", UID_Add("455667788995"));
//printf("add 3 %d\n", UID_Add("455667788999"));
//printf("del - %d\n", UID_Del("554123456789"));
...
{  // Issue HTTP request to system server for status information
   ...
   if (sock_established(&tcpsock)) {
      ...
      mktm(&timeptr, param.UIDSync);
		sprintf(postContent,"sysnum=%d&trct=%ld&refr=%04d%02d%02d%02d%02d%02d", param.systemNum, transactionCount(),
